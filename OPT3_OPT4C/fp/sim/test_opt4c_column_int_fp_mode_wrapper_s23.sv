module test_opt4c_column_int_fp_mode_wrapper_s23;
...
opt4c_column_int_fp_mode_wrapper_s23 #(
    .N(N)
) dut (
    .clk(clk),
    .rst_n(rst_n),
...
initial begin
    ...
    $display("\033[1;32mSUCCESS: OPT4C column INT/FP S23-merged wrapper tests passed.\033[0m");
    $finish;
end
