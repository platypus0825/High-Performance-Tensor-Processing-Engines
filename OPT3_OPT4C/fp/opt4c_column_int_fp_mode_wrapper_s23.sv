module opt4c_column_int_fp_mode_wrapper_s23 #(
    parameter N = 4,
...
localparam logic [3:0] S_BW_RUN     = 4'd4;
localparam logic [3:0] S_BW_GAP     = 4'd5;
localparam logic [3:0] S_ROW_DRAIN  = 4'd6;
localparam logic [3:0] S_ACC_ROW    = 4'd7;
