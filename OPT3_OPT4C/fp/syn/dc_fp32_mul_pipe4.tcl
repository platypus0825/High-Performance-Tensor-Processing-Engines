...
set my_verilog_list          "filelist_fp32_pipe4.f"
set my_current_design_name   fp32_mul_7bit_chunk_pipe4
set my_current_file_name     fp32_mul_7bit_chunk_pipe4
