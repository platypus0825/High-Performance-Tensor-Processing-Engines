...
set my_verilog_list          "filelist_column_int_fp_wrapper_s23.f"
set my_current_design_name   opt4c_column_int_fp_mode_wrapper_s23
set my_current_file_name     opt4c_column_int_fp_mode_wrapper_s23
...
# Keep the shared OPT4C column as a recognizable INT datapath boundary. The
# experiment is about moving mode selection to the column boundary, not about
# letting DC absorb FP scheduling logic into the original PE column.
