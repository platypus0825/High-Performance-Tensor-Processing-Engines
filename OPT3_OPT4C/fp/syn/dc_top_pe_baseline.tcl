...
set my_verilog_list          "filelist_top_pe_baseline.f"
set my_current_design_name   top_pe
set my_current_file_name     top_pe_baseline
...
# Match the original OPT4C array flow so this is a fair single-PE baseline for
# the INT/FP wrapper timing report.
