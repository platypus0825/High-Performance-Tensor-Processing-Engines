...
set my_verilog_list          "filelist_int_fp_wrapper_pipepe_cfg.f"
set my_current_design_name   opt4c_int_fp_mode_wrapper_pipepe_cfg
set my_current_file_name     opt4c_int_fp_mode_wrapper_pipepe_fpclean_fp
...
# FP-mode diagnostic for the shared-PE/pipePE structure. INT ports are inactive
# in this mode; FP scheduler, shared PE, shift, and accumulation remain active.
