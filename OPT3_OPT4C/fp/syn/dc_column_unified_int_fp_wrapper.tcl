...
set my_verilog_list          "filelist_column_unified_int_fp_wrapper.f"
set my_current_design_name   opt4c_column_unified_int_fp_wrapper
set my_current_file_name     opt4c_column_unified_int_fp_wrapper
